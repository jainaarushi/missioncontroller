    ...
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="mb-8 flex justify-between items-end">
        ...
        <div className="flex gap-3">
          ...
          <button className="px-4 py-2 text-sm font-semibold text-[#ba1a1a] bg-[rgba(255,218,214,0.2)] border border-[rgba(186,26,26,0.2)] rounded-lg flex items-center gap-2 hover:bg-[rgba(255,218,214,0.4)] transition-colors">
      ...
      <div className="grid grid-cols-12 gap-6">
        {/* 1. Batch Overview & Progress (Large Hero Card) */}
        <div className="col-span-12 lg:col-span-8 bg-white p-8 rounded-xl border border-slate-200 shadow-sm relative overflow-hidden">
          <div className="flex justify-between items-start relative z-10">
            <div>
              <span className="px-2.5 py-1 bg-[rgba(77,75,255,0.1)] text-[#3028e9] text-[10px] font-bold uppercase tracking-wider rounded-full border border-[rgba(48,40,233,0.2)]">
            ...
            <div className="text-right">
              <p className="text-4xl font-black text-[#006c05]">33%</p>
          ...
          <div className="mt-10 relative z-10">
            <div className="flex justify-between text-sm mb-2">
              <span className="font-semibold text-slate-700">4 of 12 Sent</span>
              <span className="text-slate-400">8 Pending</span>
            </div>
            <div className="h-4 bg-slate-100 rounded-full overflow-hidden flex">
              <div className="h-full bg-[#006c05] w-1/3 transition-all duration-500"></div>
              <div className="h-full bg-[#3028e9] w-[8%] opacity-30 animate-pulse"></div>
            </div>
          </div>
        ...
        {/* 2. Throttle Control (Smaller Bento) */}
          ...
          <div className="flex-1 space-y-6">
            ...
            <div className="p-4 bg-[#eeeeee] rounded-lg">
              <p className="text-xs text-slate-600 leading-relaxed italic">
                &ldquo;Balanced speed mimics human interaction patterns to prevent
                LinkedIn rate limiting.&rdquo;
              </p>
            </div>
          </div>
        </div>

        {/* 3. Final Deployment Analytics */}
        <div className="col-span-12 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-[rgba(77,75,255,0.1)] flex items-center justify-center text-[#3028e9]">
            ...
            <div>
              ...
              <p className="text-xl font-extrabold">8 remaining</p>
            </div>
          </div>
        </div>

        {/* 4. Recipient Queue List */}
